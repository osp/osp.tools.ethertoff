...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pad.display_name'
        db.add_column(u'etherpadlite_pad', 'display_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'Pad.display_slug'
        db.add_column(u'etherpadlite_pad', 'display_slug',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pad.display_name'
        db.delete_column(u'etherpadlite_pad', 'display_name')

        # Deleting field 'Pad.display_slug'
        db.delete_column(u'etherpadlite_pad', 'display_slug')
